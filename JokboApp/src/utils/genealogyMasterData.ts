...
let storedRequests: MasterVerificationRequest[] = [
  {
    ...
    parentInfo: '부: 홍길동(洪吉童), 모: 정서연(鄭瑞然)',
    ...
    applicantEmail: 'gildong.hong@jokbo.com',
    ...
    masterReviewNote: '【마스터 1차 소견】: 부친 홍길동(29세·赫 항렬)의 장녀로서 직계 계통 무결성이 확인되었습니다. 현재 대종회 소장 무진보(戊辰譜) 제14권 382페이지 판도판서공파 30세(29세손) 계통부에 등재 실사 중입니다.',
    confirmedClanGen: 30,
